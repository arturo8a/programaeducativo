...
public class IieeReporteDto {
	...
	String distrito;
	String nombreIiee;
	String codigoLocalIiee;
	String fechaRegistro;
	String inscrioCe;
	String nivelSeccionDocenteAlumnoVaronMujer;
	String ambito;
	String modalidadEnsenianza;
	String codigoLocal;
	String tipoIiee;
	String direccion;
	String dre;
	...
	String celularDirector;
	String correoDirector;
	String tipoDocProfesor;
	String nroDocProfesor;
	String apellidosProfesor;
	String nombresProfesor;
	String generoProfesor;
	...
	String nivelParticipacionTrabajo;
	String ejesTematicos;
	String nombreParticipante;
	String apellidoPaternoParticipante;
	String apellidoMaternoParticipante;
	String tipoDocumentoParticipante;
	String nroDocumentoParticipante;
	String fechaNacimientoParticipante;
	String generoParticipante;
	String SeccionParticipante;
	String nivelParticipante;
	String gradoParticipante;
	String nombreTutor;
	String apellidoPaternoTutor;
	String apellidoMaternoTutor;
	String tipoDocumentoTutor;
	String nroDocumentoTutor;
	String telefonoTutor;
	String correoTutor;
	String parentesco;
	String nombreDocente;
	String apellidoPaternoDocente;
	String apellidoMaternoDocente;
	String tipoDocumentoDocente;
	String nrodocumentoDocente;
	...
	public String getNombreIiee() {
		return nombreIiee;
	}
	public void setNombreIiee(String nombreIiee) {
		this.nombreIiee = nombreIiee;
	}
	public String getCodigoLocalIiee() {
		return codigoLocalIiee;
	}
	public void setCodigoLocalIiee(String codigoLocalIiee) {
		this.codigoLocalIiee = codigoLocalIiee;
	}
	...
	public String getInscrioCe() {
		return inscrioCe;
	}
	public void setInscrioCe(String inscrioCe) {
		this.inscrioCe = inscrioCe;
	}
	public String getNivelSeccionDocenteAlumnoVaronMujer() {
		return nivelSeccionDocenteAlumnoVaronMujer;
	}
	public void setNivelSeccionDocenteAlumnoVaronMujer(String nivelSeccionDocenteAlumnoVaronMujer) {
		this.nivelSeccionDocenteAlumnoVaronMujer = nivelSeccionDocenteAlumnoVaronMujer;
	}
	...
	public String getModalidadEnsenianza() {
		return modalidadEnsenianza;
	}
	public void setModalidadEnsenianza(String modalidadEnsenianza) {
		this.modalidadEnsenianza = modalidadEnsenianza;
	}
	...
	public String getTipoIiee() {
		return tipoIiee;
	}
	public void setTipoIiee(String tipoIiee) {
		this.tipoIiee = tipoIiee;
	}
	...
	public String getTelfIiee() {
		return telfIiee;
	}
	public void setTelfIiee(String telfIiee) {
		this.telfIiee = telfIiee;
	}
	public String getEmailIiee() {
		return emailIiee;
	}
	public void setEmailIiee(String emailIiee) {
		this.emailIiee = emailIiee;
	}
	...
	public String getHorasAbastecimiento() {
		return horasAbastecimiento;
	}
	public void setHorasAbastecimiento(String horasAbastecimiento) {
		this.horasAbastecimiento = horasAbastecimiento;
	}
	...
	public String getTipoDocDirector() {
		return tipoDocDirector;
	}
	...
	public String getNombresDirector() {
		return nombresDirector;
	}
	public void setNombresDirector(String nombresDirector) {
		this.nombresDirector = nombresDirector;
	}
	...
	public String getNroDocProfesor() {
		return nroDocProfesor;
	}
	public void setNroDocProfesor(String nroDocProfesor) {
		this.nroDocProfesor = nroDocProfesor;
	}
	...
	public String getNivelParticipacionTrabajo() {
		return nivelParticipacionTrabajo;
	}
	public void setNivelParticipacionTrabajo(String nivelParticipacionTrabajo) {
		this.nivelParticipacionTrabajo = nivelParticipacionTrabajo;
	}
	...
	public String getNroDocumentoParticipante() {
		return nroDocumentoParticipante;
	}
	public void setNroDocumentoParticipante(String nroDocumentoParticipante) {
		this.nroDocumentoParticipante = nroDocumentoParticipante;
	}
	public String getFechaNacimientoParticipante() {
		return fechaNacimientoParticipante;
	}
	public void setFechaNacimientoParticipante(String fechaNacimientoParticipante) {
	...
	public String getSeccionParticipante() {
		return SeccionParticipante;
	}
	public void setSeccionParticipante(String seccionParticipante) {
		SeccionParticipante = seccionParticipante;
	}
	public String getNivelParticipante() {
		return nivelParticipante;
	}
	public void setNivelParticipante(String nivelParticipante) {
		this.nivelParticipante = nivelParticipante;
	}
	public String getGradoParticipante() {
		return gradoParticipante;
	}
	public void setGradoParticipante(String gradoParticipante) {
		this.gradoParticipante = gradoParticipante;
	}
	...
	public String getNrodocumentoDocente() {
		return nrodocumentoDocente;
	}
	public void setNrodocumentoDocente(String nrodocumentoDocente) {
		this.nrodocumentoDocente = nrodocumentoDocente;
	}

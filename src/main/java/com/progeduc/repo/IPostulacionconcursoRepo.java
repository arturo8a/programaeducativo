...
public interface IPostulacionconcursoRepo  extends CrudRepository<Postulacionconcurso,Integer> {
	...
	@Query(value="select tb1.anio from POSTULACIONCONCURSO tb1 where tb1.anio<EXTRACT(YEAR FROM sysdate) group by tb1.anio order by tb1.anio asc",nativeQuery = true)
